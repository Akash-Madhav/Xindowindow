...
export default function Footer() {
  return (
    <footer className="relative bg-[var(--color-obsidian)] border-t border-[var(--color-black-light)] pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 w-full overflow-hidden z-20 industrial-texture" data-section-id="09">
      ...
      <div className="max-w-[1400px] 2xl:max-w-[1800px] mx-auto px-5 sm:px-8 md:px-16 relative z-10 flex flex-col">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-12 mb-32">
          ...
          <div className="flex flex-col">
            <Link href="/" className="flex items-center gap-4 mb-8 w-fit group">
              <div className="w-[44px] h-[44px] border-2 border-[var(--color-red)] flex items-center justify-center group-hover:bg-[var(--color-red)] transition-all duration-300">
            ...
            <p className="font-sans font-normal text-[15px] leading-[1.7] text-[var(--color-silver)] mb-10 opacity-80 italic border-l border-[var(--color-red-muted)] pl-6">
              ...
              {[
                ...
                <li key={link.name}>
                  <Link href={link.href} className="font-sans font-semibold text-[13px] text-[var(--color-silver)] hover:text-[var(--color-white)] hover:translate-x-2 transition-all duration-300 uppercase tracking-widest flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-[var(--color-red-muted)] rounded-full opacity-0 group-hover:opacity-100" />
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-6">
              ...
              <a href="https://wa.me/919444045544" className="font-sans font-bold text-[13px] text-[var(--color-red)] hover:text-[var(--color-white)] uppercase tracking-[0.2em] transition-all duration-300 block border border-[var(--color-red-muted)] p-4 text-center">
        ...
        <div className="border-t border-[var(--color-black-light)] pt-10 flex flex-col md:flex-row items-center justify-between gap-6 w-full">
          ...
          <div className="flex gap-8">
            <span className="font-mono text-[10px] text-[var(--color-red)] uppercase tracking-[0.3em] font-bold">GS-9001 Certified Plant</span>
