...
export default function Hero() {
  ...
  const headlineLine1 = "Engineering".split(" ")
  const headlineLine2 = "The Future".split(" ")
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 bg-black">
        ...
        >
          <source src="https://assets.mixkit.co/videos/preview/mixkit-architectural-shot-of-a-modern-building-4475-large.mp4" type="video/mp4" />
        </video>
      ...
      <div className="w-full max-w-[1400px] 2xl:max-w-[1920px] mx-auto px-5 sm:px-8 md:px-16 z-20 relative flex-grow flex flex-col items-center justify-between py-32 lg:py-48 mt-16 sm:mt-24">
        ...
        <div className="flex flex-col items-center">
          ...
          <h1 className="font-display font-black text-[32px] sm:text-[60px] lg:text-[100px] xl:text-[130px] 2xl:text-[160px] 3xl:text-[200px] tracking-[-0.05em] sm:tracking-[-0.07em] text-[var(--color-white)] leading-[0.9] sm:leading-[0.85] flex flex-col items-center uppercase italic">
            ...
            <div className="flex flex-wrap justify-center overflow-hidden h-fit py-1 text-[var(--color-primary)]">
              {headlineLine2.map((word, i) => (
                <div 
                  key={i + headlineLine1.length} 
                  ref={el => { headlineWordsRef.current[i + headlineLine1.length] = el }}
                  className="mr-[0.2em] last:mr-0 inline-block translate-y-[110%]"
                >
                  {word}
                </div>
          ...
          >
            Crafting high-value industrial infrastructure through state-of-the-art German uPVC technology. Architectural precision designed for the future of Indian living.
          </p>
          ...
          >
            ...
            >
              <span className="relative z-10 font-sans uppercase text-[12px] sm:text-[13px] tracking-[0.4em] font-black">Configure Project</span>
            ...
            <Link
              ...
              data-cursor="link"
            >
              <span className="font-mono uppercase text-[11px] sm:text-[12px] tracking-[0.3em] font-bold mr-6">Facility Tour</span>
      ...
      <div className="absolute -bottom-20 left-0 w-full pointer-events-none z-0 hidden lg:block opacity-[0.02]">
        <div className="flex justify-between px-20">
          <span className="font-display font-black text-[300px] leading-none uppercase italic">XINDO</span>
          <span className="font-display font-black text-[300px] leading-none uppercase italic">PRECISION</span>
        </div>
      </div>
    </section>
  )
