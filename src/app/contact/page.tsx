  ...
  return (
    <main className="min-h-screen bg-[var(--color-black)] selection:bg-[var(--color-primary)] selection:text-[var(--color-white)]">
      ...
      <div className="py-24 px-6 max-w-[800px] mx-auto text-center opacity-60">
         ...
         <p className="text-[var(--color-silver)] font-light text-[14px] leading-relaxed italic">Have a technical question about our uPVC systems or installation process? Our technical help desk is available for deep-dive specification analysis.</p>
      </div>
    </main>
  )
}
